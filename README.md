...
当前仓库没有检测到 `screenshots/` 或 `docs/` 图片资源。

TODO:

- Add screenshots for frontend upload page.
- Add screenshots for RAG chat / QA page.
- Add screenshots for JD analysis submit, status polling and report page.
